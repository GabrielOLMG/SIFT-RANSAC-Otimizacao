...
def get_keypoints_descriptors(sift, dict_of_images):
    ...
    for image_path, image in tqdm.tqdm(dict_of_images.items()):
        ...
        print(f"TOTAL KEYPOINTS {len(keypointTemp)}")
...
def _compare_keypoints_descriptors(keypoints_descriptors_image_1, keypoints_descriptors_image_2, same=None):
    ...
    if same is None:
        ...
        print(f"\t\t\t [{same}]{score_1} --- {score_2} --- {ssim_value}")
    '''
...
def compare_keypoints_descriptors(info_1_keypoints_descriptors_images, info_2_keypoints_descriptors_images):
    score_same1 = []
    score_n_same1 = []
    score_same2= []
    score_n_same2 = []
    for image_path_1,keypoints_descriptors_image_1 in info_1_keypoints_descriptors_images.items():
        for image_path_2,keypoints_descriptors_image_2 in info_2_keypoints_descriptors_images.items():
            ...
            score_1, score_2 = _compare_keypoints_descriptors(keypoints_descriptors_image_1, keypoints_descriptors_image_2, same=same)
